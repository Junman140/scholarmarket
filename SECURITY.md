...
**Email:** security@scholarmarket.io (or your-email@example.com)

## Security Model
ScholarMarket is a non-custodial platform:
...
| Component | Status |
| :--- | :--- |
| ScholarMarket Frontend | In Scope |
| ScholarMarket API Routes | In Scope |
