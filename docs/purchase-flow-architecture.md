...
To solve Issue #10, ScholarMarket implements a hybrid Web3 approach that bridges on-chain payments with off-chain entitlement enforcement.
...
### Off-Chain (ScholarMarket Backend & MongoDB)
